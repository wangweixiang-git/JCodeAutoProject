    ...
    <div class="main-content">
      <div class="panel panel-default collapsed">
        ...
        <div class="panel-body">
          ...
          <div class="row">
            <form id="TestBrhDepoAnal_form" method="post" class="validate">
              <div class="col-md-3">
...
<script type="text/javascript">
    $(function() {
        ...
        var initparams01 = {
            "ajax" : {
                "url" : "${pageContext.request.contextPath}/prd/testbrhdepoanal/testbrhdepoanal/list",
                "type" : "POST",
                "data" : function(d) {
                    var orders = d.order;
                    console.log(orders);
                    ...
                    console.log(orders);
                    var inputName = WebUtils.convertFormData("TestBrhDepoAnal_form");
            ...
            "aoColumns" : [
                	{"data" : "pkId", "sClass" : "text-center" },
                	{"data" : "orgCode", "sClass" : "text-center" },
                	{"data" : "dataDate", "sClass" : "text-center" },
                	{"data" : "deposAmt", "sClass" : "text-center" },
                	{"data" : "deposDay", "sClass" : "text-center" },
                	{"data" : "deposMonth", "sClass" : "text-center" },
                	{"data" : "deposYear", "sClass" : "text-center" },
                	{"data" : "testdate", "sClass" : "text-center" }
            ],
            "aoColumnDefs" : []
        };
        ...
        $("#reset_button").click(function() {
        	//清空form表单数据
	       	 $("#TestBrhDepoAnal_form input").each(function(){
	            	$(this).val("");
	            });
        });
      ...
      //机构选择框
        ...
        $("#downbutton").click(function() {
            ...
            if (tableRowsCount && tableRowsCount != undefined && tableRowsCount > 0) {
                var jsonDataObj = WebUtils.convertFormData("TestBrhDepoAnal_form");
                jsonDataObj.fileName = "文件"+new Date().format("yyyyMMdd")+".xls";
                var url = "${pageContext.request.contextPath}/prd/testbrhdepoanal/testbrhdepoanal/download";
